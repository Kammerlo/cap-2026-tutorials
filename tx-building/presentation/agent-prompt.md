...
Create a Google Slides presentation for a Cardano developer tutorial titled **"Building Cardano Transactions"**. The presentation is part of the Cardano Ambassador Program (CAP) 2026.
...
- **Warning/error:** Coral red (#ff6b6b) for pitfall callouts
...
- **diagram**: Title at top, large visual/diagram in center. Text minimal.
...
- Slide 3: UTXO vs Account model comparison
- Slide 5: Transaction anatomy (inputs -> tx body -> outputs)
- Slide 6: Balancing equation visual
- Slide 7: Transaction lifecycle pipeline (off-chain vs on-chain)
- Slide 10: HD wallet derivation tree
- Slide 15: PolicyId derivation flow
...
- The audience is developers new to Cardano but experienced in programming
